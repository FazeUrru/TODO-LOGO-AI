...
describe("v1.25.0 — versión y trazabilidad", () => {
  ...
  it("changelog-meta y CHANGELOG.md relatan la 1.25.0", () => {
    expect(VERSIONS[5].version).toBe("1.26.0");
    expect(VERSIONS[6].version).toBe("1.25.1");
    expect(VERSIONS[6].diffDesde).toBe("1.25.0");
    expect(VERSIONS[7].version).toBe("1.25.0");
    expect(VERSIONS[7].diffDesde).toBe("1.24.0");
    expect(VERSIONS[7].kinds).toContain("nuevo");
    expect(VERSIONS[8].version).toBe("1.24.0");
