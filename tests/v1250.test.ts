...
describe("v1.25.0 — versión y trazabilidad", () => {
  ...
  it("changelog-meta y CHANGELOG.md relatan la 1.25.0", () => {
    expect(VERSIONS[8].version).toBe("1.26.0");
    expect(VERSIONS[9].version).toBe("1.25.1");
    expect(VERSIONS[9].diffDesde).toBe("1.25.0");
    expect(VERSIONS[10].version).toBe("1.25.0");
    expect(VERSIONS[10].diffDesde).toBe("1.24.0");
    expect(VERSIONS[10].kinds).toContain("nuevo");
    expect(VERSIONS[11].version).toBe("1.24.0");
